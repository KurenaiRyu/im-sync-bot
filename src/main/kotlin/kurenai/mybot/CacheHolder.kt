...
object CacheHolder {
    val QQ_MSG_CACHE = Cache<Int?, OnlineMessageSource?>("QQ_MSG")
    val TG_MSG_CACHE = Cache<Int?, Message?>("TG_MSG")
    val TG_QQ_MSG_ID_CACHE = Cache<Int?, Int?>("TG_QQ_MSG_ID") // tg - qq message id cache;
    val QQ_TG_MSG_ID_CACHE = Cache<Int?, Int?>("QQ_TG_MSG_ID") // qq - tg message id cache;
